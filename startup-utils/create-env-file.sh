...
echo PROXY_CONFIG="'{\"apis\":[{\"path\":\"azure-mock\",\"url\":\"http://$AZURE_HOST:8100\",\"scopes\":\"azure-mock/.default\"},{\"path\":\"websocket-server\",\"url\":\"http://host.docker.internal:1338\",\"scopes\":\"websocket-server/.default\",\"enableWebSocket\": true}]}'" >> $ENV_PATH
