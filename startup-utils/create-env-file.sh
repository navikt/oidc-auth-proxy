...
echo PROXY_CONFIG="'value:{\"apis\":[{\"path\":\"azure-mock\",\"url\":\"http://$AZURE_HOST:8100\",\"scopes\":\"azure-mock/.default\"},{\"path\":\"websocket-server\",\"url\":\"http://websocket-server:1338\",\"scopes\":\"websocket-server/.default\",\"webSocketUrl\": \"ws://websocket-server:1338/ws\"}]}'" >> $ENV_PATH
