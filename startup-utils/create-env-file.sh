...
echo OIDC_AUTH_PROXY_BASE_URL="'value:http://localhost:8101'" >> $ENV_PATH
echo APPLICATION_BASE_URL="'value:http://localhost:8101/api/azure-mock/audience-check'" >> $ENV_PATH
